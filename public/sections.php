    ...
    <main class="main">
      <header class="lm-header lm-fade lm-fade-1">
        <div class="lm-header-left">
          ...
          <h1 class="lm-title">Section Management</h1>
          <p class="lm-subtitle">Manage and categorize cemetery lots by sections</p>
        </div>
        ...
        <div class="lm-header-actions">
          <button id="addSectionBtn" class="lm-btn-primary">
      ...
      <div class="lm-stats-grid lm-fade lm-fade-2">
        <div class="lm-stat-card accent-purple">
          <div class="lm-stat-top">
            <div class="lm-stat-label">Total Sections</div>
            <div class="lm-stat-icon purple">
          ...
          <div class="lm-stat-sub">All registered sections</div>
          <div class="lm-stat-bar"><div class="lm-stat-bar-fill purple" style="width:100%"></div></div>
        </div>
        <div class="lm-stat-card accent-emerald">
          ...
          <div class="lm-stat-sub">Sections with active lots</div>
        ...
        <div class="lm-stat-card accent-rose">
          <div class="lm-stat-top">
            <div class="lm-stat-label">Unused Sections</div>
