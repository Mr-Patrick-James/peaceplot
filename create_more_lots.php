...
$sec = $conn->query("SELECT s.id FROM sections s LEFT JOIN blocks b ON s.block_id = b.id WHERE b.name = 'Block 8' AND s.name = 'Section 1'")->fetch();
...
echo "<p style='color:green;font-family:sans-serif;padding:20px;font-size:16px;'>✓ Created 239 lots (l-$start to l-$end) in Block 3, Section 1.</p>";
